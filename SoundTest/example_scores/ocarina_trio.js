import { N16, N4, N8 } from "../../sketchlib/music/durations.js";
...
const PATTERN_B2 = MusicPatterns.scale_melody(
  new Rhythm("xxxx|xxxx|xxxx|x---", N4),
  C4_MIXOLYDIAN,
  [
    // 0
    4, 2, 0, 2,
...
const PATTERN_B3 = MusicPatterns.scale_melody(
  new Rhythm("xxxxxxx.|xxx.x-..|xxxxxxx.|x.x.x-..", N8),
  C4_MIXOLYDIAN,
  [
    // 0
    0, 1, 2, 1, 0, 1, 2,
...
const PATTERN_B4 = MusicPatterns.scale_melody(
  new Rhythm(
...
const PATTERN_C1 = MusicPatterns.scale_melody(
  new Rhythm("x-x-x-x-|xxx.x-..|x-x-x-x-|xxx.x-..", N8),
  C4_MIXOLYDIAN,
  [
    // 0
    0, 2, 4, 2,
...
const PATTERN_C2 = MusicPatterns.scale_melody(
  new Rhythm("x.x.xxx.|x.x.x-..|x.x.xxxx|x.x.x-..", N8),
  C4_MIXOLYDIAN,
  [
    // 0
    0, 0, 0, 1, 0,
...
const PATTERN_C3 = MusicPatterns.scale_melody(
  new Rhythm("x..xx.x.|x..xx...|x..xx.x.|x.x.x-..", N8),
  C4_MIXOLYDIAN,
  [
    // 0
    2, 2, 0, 0,
...
const BASS = new Melody(
  ...
  PATTERN_B1,
  PATTERN_B3,
  // Outro is automatically generated by delaying the parts
);
// To make a canon (more specifically a round), have the other voices play the
// same thing after a delay of 4 bars. Each voice is also in a different octave,
// so transpose upwards.
