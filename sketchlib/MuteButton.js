...
import { Volume } from "./tone_helpers/Volume.js";
...
export class MuteButton {
  ...
  constructor(sound) {
    ...
    this.sound_toggle.events.addEventListener("toggle", (e) => {
      const state = /** @type {CustomEvent} */ (e).detail;
