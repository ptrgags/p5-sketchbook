 ...
 *
 * @see {@link https://github.com/asb2m10/dexed/blob/2e182b3db85c09083ab13c8b9b00565ce7d9ff85/Source/PluginData.cpp#L30|Dexed implementation}
 * @see {@link https://homepages.abdn.ac.uk/d.j.benson/pages/dx7/sysex-format.txt|DX7 sysex format}
 * @param {Uint8Array} bytes bytes to sum
 * @returns {number} The checksum
 */
export function dx7_checksum(bytes) {
  const sum = bytes.reduce((acc, x) => acc + x, 0);
